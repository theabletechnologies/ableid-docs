...
После завершения сессии идентификации система отправит webhook-уведомление на все URL, указанные в параметре `hooks`.
...
Webhook отправляется при успешной биометрической идентификации резидента.
...
Webhook отправляется при провале биометрической идентификации (лицо не совпало).
...
Webhook отправляется при успешной биометрической идентификации нерезидента.
